const fetchPokemon = () => {
    ...
    fetch(url).then((res) => {
        if (res.status != "200") {
            ...
            document.getElementById("pokeEvo1").src = "./assets/images/pokeball.png";
            document.getElementById("pokeEvo3").src = "./assets/images/pokeball.png";
            document.getElementById("pokeEvo2").src = "./assets/images/pokeball.png";
